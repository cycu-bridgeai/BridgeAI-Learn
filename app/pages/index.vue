...
<template>
  <div>
    ...
    <section class="relative py-12 sm:py-20 lg:py-24 px-4 overflow-hidden bg-white dark:bg-gray-900 transition-colors duration-300">
      <!-- Gradient Background -->
      <div class="absolute inset-0 -z-10">
        <div class="absolute inset-0 bg-gradient-to-br from-blue-50 dark:from-gray-800 via-purple-50 dark:via-blue-900/20 to-pink-50 dark:to-purple-900/20 transition-colors duration-300" />
      ...
      <div class="absolute top-0 left-0 w-20 sm:w-40 h-20 sm:h-40 opacity-10 dark:opacity-20 text-gray-900 dark:text-blue-300">
      ...
      <div class="absolute bottom-0 right-0 w-20 sm:w-40 h-20 sm:h-40 opacity-10 dark:opacity-20 text-gray-900 dark:text-blue-300">
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
          <defs>
