  ...
  >
    ...
    <div class="p-4 sm:p-6 flex flex-col flex-1 relative z-10 pointer-events-none">
      ...
      <div class="mt-auto pointer-events-auto">
        <!-- Tag section (Moved above buttons, added margin bottom) -->
        <div v-if="work.tags?.length || work.date" class="flex flex-wrap items-center gap-y-2 mb-4">
        ...
        <!-- Quick Action Links (At the very bottom, with top border) -->
        <div v-if="work.demoUrl || work.githubUrl" class="flex items-stretch gap-2 pt-4 border-t border-gray-100 dark:border-gray-800 z-20 relative">
          <a
            v-if="work.demoUrl"
            :href="work.demoUrl"
            target="_blank"
            rel="noopener noreferrer"
            class="flex-1 py-1.5 px-3 bg-purple-600 hover:bg-purple-700 text-white text-xs font-semibold rounded-lg flex items-center justify-center gap-1 transition-all hover:scale-105 active:scale-95 border border-transparent"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="flex-1 py-1.5 px-3 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs font-semibold rounded-lg flex items-center justify-center gap-1 transition-all hover:scale-105 active:scale-95 border border-gray-200 dark:border-gray-700"
          >
